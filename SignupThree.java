    ...
    SignupThree(String formno){
     ...
     type.setFont(new Font("Raleway",Font.BOLD,22));
       type.setBounds(100,140,200,40);
        ...
        r1=new JRadioButton("Saving Acccount");
...
pindetail.setBounds(100,410,300,20);
 ...
 services.setFont(new Font("Raleway",Font.BOLD,22));
  ...
  c1.setBounds(100,500,300,40);
        add(   c1);
      
          c2=new JCheckBox("Internet Banking");
         c2.setFont(new Font("Raleway",Font.BOLD,16));
 c2.setBounds(350,500,300,40);
        add(  c2);
          c3=new JCheckBox("Mobile Banking");
        c3.setFont(new Font("Raleway",Font.BOLD,16));
   c3.setBounds(100,550,300,40);
        add(  c3);
          c4=new JCheckBox("Email & SMS Alerts");
        c4.setFont(new Font("Raleway",Font.BOLD,16));
  c4.setBounds(350,550,300,40);
        add(  c4);
          c5=new JCheckBox("Cheque Book");
          c5.setFont(new Font("Raleway",Font.BOLD,16));
   c5.setBounds(100,600,300,40);
        add(    c5);
          c6=new JCheckBox("E-Statement");
        c6.setFont(new Font("Raleway",Font.BOLD,16));
 c6.setBounds(350,600,300,40);
        add(  c6);
          c7=new JCheckBox(" I hereby Declare that the above entered details are correct to the best of my knowledge");
        c7.setFont(new Font("Raleway",Font.BOLD,12));
  c7.setBounds(100,680,600,40);
        add(   c7);
        ...
        submit.setBounds(200, 720, 200, 30);
        ...
        add(submit);
         ...
         cancel.setBounds(500, 720, 200, 30);
